...
fn validate_role_weighting() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        EXP,
        "creator_gt_contributor",
        bool_f64(creator_gt_contributor),
        1.0,
        0.0,
    ));
    ...
    results.push(ValidationResult::check(
        EXP,
        "contributor_gt_validator",
        bool_f64(contributor_gt_validator),
        1.0,
        0.0,
    ));
    ...
    results.push(ValidationResult::check(
        EXP,
        "validator_gt_observer",
        bool_f64(validator_gt_observer),
        1.0,
        0.0,
    ));
...
fn validate_decay_models() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        EXP,
        "linear_never_negative",
        bool_f64(linear.apply(1.0, 200) >= 0.0),
        1.0,
        0.0,
    ));
    ...
    results.push(ValidationResult::check(
        EXP,
        "exponential_approaches_zero",
        bool_f64(large_ticks < 0.001),
        1.0,
        0.0,
    ));
...
fn validate_single_creator() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        EXP,
        "single_creator_verify_sum",
        bool_f64(verify_distribution(&dist)),
        1.0,
        0.0,
    ));
...
fn validate_multi_contributor() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        ...
        bool_f64(creator_share > contributor_share && creator_share > validator_share),
        1.0,
        0.0,
    ));
...
fn validate_time_decay() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        EXP,
        "exponential_decay_late_larger",
        bool_f64(late_dec > early_dec),
        1.0,
        0.0,
    ));
    results.push(ValidationResult::check(
    ...
    results.push(ValidationResult::check(
        EXP,
        "exponential_decay_verify",
        bool_f64(verify_distribution(&with_decay)),
        1.0,
        0.0,
    ));
...
fn validate_deep_chain() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        ...
        bool_f64(creator_share > validator_share),
        1.0,
        0.0,
    ));
    results.push(ValidationResult::check(
        EXP,
        "deep_deepest_smallest",
        bool_f64(validator_share < creator_share),
        1.0,
        0.0,
    ));
...
fn validate_domain_scenarios() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        EXP,
        "science_pi_less_than_collector",
        bool_f64(pi_share < collector_share),
        1.0,
        0.0,
    ));
    ...
    results.push(ValidationResult::check(
        EXP,
        "medical_patient_most",
        bool_f64(patient_share > 0.2),
        1.0,
        0.0,
    ));
    results.push(ValidationResult::check(
...
fn validate_cascade_simulation() -> Vec<ValidationResult> {
    ...
    results.push(ValidationResult::check(
        ...
        bool_f64(alice_earned > 0.0 && bob_earned > 0.0),
        1.0,
        0.0,
    ));
