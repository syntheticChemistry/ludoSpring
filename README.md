...
**Date:** April 20, 2026
**Version:** V46 (guideStone readiness 4: `ludospring_guidestone` three-tier — Tier 1 LOCAL_CAPABILITIES (20 bare checks), Tier 2 IPC-WIRED (15 domain science checks), Tier 3 FULL NUCLEUS (8 cross-atomic checks: BearDog crypto + NestGate storage roundtrip + pipeline). BLAKE3 Property 3 via `validation/CHECKSUMS`. Protocol tolerance. **791** workspace tests (0 failed). plasmidBin v0.10.0.)
**Spring alignment table:** The ludoSpring row in sibling `../primalSpring/wateringHole/NUCLEUS_SPRING_ALIGNMENT.md` uses the same workspace test total as this README (**791** as of V46); if they diverge, treat this README and `cargo test --workspace` as canonical.
