...
**Date:** May 12, 2026
**Version:** V66 (`--format json` flag on `ludospring validate` for Tier 2 toadStool integration. barraCuda v0.4.0 absorbed. params GPU domain split. V65: Thread 9+10 expressions, notebook CI. 854 tests, zero clippy, zero unsafe.)
