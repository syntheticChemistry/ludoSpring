...
**Date:** April 25, 2026
**Version:** V48 (Phase 45c debt resolution — **BTSP relay**, `interaction.poll`, honest `push_scene`. Cell graph ready: `ludospring_cell.toml` (14 nodes, all BTSP). Live NUCLEUS validated: 54/54 guideStone checks (V47). **798** workspace tests. genomeBin v5.1.)
**Spring alignment table:** The ludoSpring row in sibling `../primalSpring/wateringHole/NUCLEUS_SPRING_ALIGNMENT.md` uses the same workspace test total as this README (**798** as of V48); if they diverge, treat this README and `cargo test --workspace` as canonical.
