...
**Date:** Jun 3, 2026
**Version:** V82 (Wave 76 parity sprint complete. Deep debt resolved — lenses.rs refactored to const fn data table. ironGate operational. primalSpring v0.9.31, 32 capabilities, 995 tests, zero clippy, zero unsafe.)
...
| Deploy graph | `deploy/ludospring.toml` | primalSpring deploy fragment: 32 capabilities (28 game + 4 health), optional trio + viz deps |
