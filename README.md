...
**Date:** April 11, 2026
**Version:** V42 (Composition evolution: `lifecycle.composition` handler wired, capability-first discovery (`by_capability` → name fallback), `nest_atomic` declared in fragments, provenance unified to single commit `19e402c0`, ecoBin banned-crate enforcement in `deny.toml`, fog_of_war.wgsl README reconciled. **781** workspace tests (0 failed). Python validated Rust; Rust+Python now validate NUCLEUS composition patterns.)
