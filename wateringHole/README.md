...
|---------|------|------|-------|
| **V76** | [LUDOSPRING_V76_DOWNSTREAM_ABSORPTION_HANDOFF_MAY19_2026.md](handoffs/LUDOSPRING_V76_DOWNSTREAM_ABSORPTION_HANDOFF_MAY19_2026.md) | May 19 | **Current** — Downstream absorption guide for projectNUCLEUS, projectFOUNDATION, esotericWebb, petalTongue. Integration patterns, workload TOMLs, GAP-021/002 evolution paths. |
...
| GAP-12: Registry cross-sync | **primalSpring** | **RESOLVED** | V59: 28 `game.*` methods registered (452 total, Wave 20: `primal.list` added) |
