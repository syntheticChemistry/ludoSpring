...
validates 16 foundational models from HCI/game science research — Fitts's law (1954),
...
Schell Game Design Lenses (2008), Perlin noise (1985), Wave Function Collapse (2016),
L-systems (1968), BSP trees (1980), and Tufte data-ink analysis (1983) — through the
ecoPrimals 3-tier validation ladder:
...
- Schell (2008) — Game Design Lenses (20-lens structural analysis framework)
