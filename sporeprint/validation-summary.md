...
description = "Game science, HCI, procedural generation — 956 tests, 15 models validated (Bartle + Deterding added), composition validation escalation, BM-004/005 benchmarks, Tower Atomic LIVE 6/6, petalTongue scene composition + meta-validation, Foundation Threads 9+10 active"
date = 2026-05-16
...
- **956** workspace tests (unit, integration, property, determinism, parity, composition)
- **15 foundational models** validated against published research (13 HCI + Bartle Player Types + Deterding Gamification)
...
- **28 `game.*` capabilities** registered canonically (primalSpring 452-method registry)
