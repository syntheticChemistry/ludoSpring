...
|--------|---------|-----------------|
| `fog_of_war.wgsl` | Per-tile visibility from viewer position — distance-based radial mask with explored-state tracking. Terrain buffer bound but occlusion not yet wired (Bresenham line-of-sight is a planned Tier C promotion) | 1 thread/tile, single dispatch |
